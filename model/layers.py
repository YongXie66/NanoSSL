...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, query, key, value, mask=None): 
        '''
        self-attention时的Q, K, V都是同一个输入X
        cross-attention时的Q是mask_token, K, V是visible_token
        ''' 
...
class CrossAttnTRMBlock(nn.Module):
    ...
    def forward(self, rep_visible, rep_mask_token, mask=None): # rep_mask_token是Q, rep_visible是K, V
